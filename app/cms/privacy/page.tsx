// app/(admin)/cms/privacy-policy/page.tsx
"use client"
...
export default function PrivacyPolicyPage() {
  ...
  const loadContent = async () => {
    setIsLoading(true)
    try {
      const response = await authenticatedFetch('/api/cms/privacy-policy', {
        method: 'GET'
      })
    ...
    try {
      ...
      if (data.success) {
        ...
        alert('✅ Content saved successfully!\n\nMobile app can access at:\n' + 
              `${API_BASE_URL.replace('/api', '')}/api/public/cms/privacy-policy`)
      } else {
        setSaveStatus('error')
  ...
  const getWebViewURL = () => {
    return `${API_BASE_URL.replace('/api', '')}/api/public/cms/privacy-policy`
  }
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border border-blue-200 rounded-lg p-6">
              <div className="flex items-center justify-between mb-6">
                <h1 className="text-2xl font-semibold text-[#000000]">Privacy Policy</h1>
